...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-10 07:50`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/de71d252-56f3-4b1d-a6cb-d1503da0e388.git
$ cd de71d252-56f3-4b1d-a6cb-d1503da0e388
```
